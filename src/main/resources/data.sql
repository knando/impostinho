...
insert into medico(cpf, data_admissao, nome, ativo, usuario_id)
values ('584.679.714-84', '2002-01-15', 'Rogerio Lima','true', 3),
('048.501.290-13', '1995-10-11', 'Bárbara Alves','true', 4);
